...
require(['jquery'], function ($) {
	...
	settingsFn.prototype = {
		...
		apply: function () {
			...
			// 加载LOGO
			if (that.get('logo')) {
				 $(".logo").html('<img src="' + "icon/logo1.png"+ '" />');
			} else {
                                         $(".logo").html('<img src="' + "icon/logo1.png"+ '" />');
	...
	var bookMarkFn = function (ele, options) {
		this.$ele = $(ele);
		this.options = {
			data: [{ "name": "建全精选", "url": "choice()", "icon": "icon/discover.png" }, { "name": "建全影视", "url": "https://555dy.fun/", "icon": "icon/weibo.png" }, { "name": "霹雳影视", "url": "https://plyingshi.com/", "icon": "icon/bilibilibog.png" }, { "name": "可乐影城", "url": "https://cokemv.me/", "icon": "icon/zhihu.png" }, { "name": "莫扎特影", "url": "https://mozhatu.com/", "icon": "icon/taobao.png" }, { "name": "建全官网", "url": "https://jianquan888.github.io/", "icon": "icon/tieba.png" }, { "name": "建全素材", "url": "https://www.aewz.com/", "icon": "icon/ithome.png" }, { "name": "大米影视", "url": "https://dmxq6.com/", "icon": "icon/netease.png" }, { "name": "建全热榜", "url": "https://tophub.today", "icon": "icon/tophub.png" }, { "name": "奈菲影视", "url": "https://yanetflix.com/", "icon": "icon/pp93.png" }],
		};
